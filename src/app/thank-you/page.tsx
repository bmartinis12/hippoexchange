    ...
    return (
        <main className="relative lg:min-h-full">
            <div className="hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
                <Image src='/checkout-thank-you.jpg' fill sizes="100%" className="h-full w-full object-cover object-center" alt="thank you for your order" priority />
            </div>
            <div>
                    ...
                    <div className="lg:col-start-2">
                        ...
                        {order._isPaid ? (
                            <p className="mt-2 text-base text-muted-foreground">
                                Your order was processed and your assets are available to download below. We&apos;ve sent your recipt and order details to{' '}
                                        ...
                                        <li key={product.id} className="flex space-x-6 py-6">
                                            <div className="relative h-24 w-24">
                                                {typeof image !== 'string' && image.url ? (
                                                    <Image src={image.url} fill sizes="100%" alt={`${product.name}`} className="flex-none rounded-md bg-gray-100 object-cover object-center" />
                                                ) : null}
                                            </div>
                                            ...
                                            <p className="flex-non font-medium text-gray-900">{formatPrice(product.price)}</p>
                                        </li>
                                    )
                                })}
                            </ul>
