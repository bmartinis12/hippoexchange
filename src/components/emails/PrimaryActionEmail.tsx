...
const EmailTemplate = ({ actionLabel, buttonText, href }: EmailTemplateProps) => {
    return (
        <Html>
            <Head />
            ...
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Text style={paragraph}>
                        Welcome to HippoExchange, the marketplace for high quality digital
