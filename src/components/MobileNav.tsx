                                    ...
                                    <li
                                        ...
                                        <div className='grid grid-cols-2 gap-y-10 gap-x-4'>
                                            {category.featured.map((item) => (
                                                <Link href={item.href} key={item.name} className='group relative text-sm' onClick={() => setIsOpen(false)} >
                                                    <div className='relative aspect-square overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75'>
                                                        <Image fill sizes='100%' src={item.imageSrc} alt='product category image' className='object-cover object-center' />
                                                    </div>
